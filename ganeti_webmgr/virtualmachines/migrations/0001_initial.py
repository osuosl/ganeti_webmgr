...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.rename_table("ganeti_web_virtualmachine", "virtualmachines_virtualmachine")
        db.send_create_signal('virtualmachines', ['VirtualMachine'])


    def backwards(self, orm):
        # Deleting model 'VirtualMachine'
        db.rename_table("virtualmachines_virtualmachine", "ganeti_web_virtualmachine")

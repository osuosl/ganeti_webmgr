...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('virtualmachines_virtualmachine', 'hostname', self.gf('ganeti_webmgr.utils.fields.LowerCaseCharField')(max_length=128))

    def backwards(self, orm):

        # Changing field 'VirtualMachine.hostname'
        db.alter_column('virtualmachines_virtualmachine', 'hostname', self.gf('django.db.models.fields.CharField')(max_length=128))

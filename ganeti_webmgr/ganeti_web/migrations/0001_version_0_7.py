...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('ganeti_web_job', (
            ...
            ('cached', self.gf('ganeti_webmgr.utils.fields.PreciseDateTimeField')(null=True, max_digits=18, decimal_places=6)),
            ...
            ('mtime', self.gf('ganeti_webmgr.utils.fields.PreciseDateTimeField')(null=True, max_digits=18, decimal_places=6)),

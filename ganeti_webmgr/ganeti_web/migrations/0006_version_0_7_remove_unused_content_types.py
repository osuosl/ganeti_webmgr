...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        """
        Delete content types for the old tables that are no longer used:
            - old perm models used by object_permissions
            - models from ganeti app
        """
        ContentType = orm['contenttypes.contenttype']
        cts = ContentType.objects \
            .filter(app_label='object_permissions') \

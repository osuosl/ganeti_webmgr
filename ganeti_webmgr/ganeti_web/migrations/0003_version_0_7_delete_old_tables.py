...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        """ delete tables that were used in version 0.6 and earlier """
        self.safe_delete('ganeti.testmodel')
        self.safe_delete('ganeti.quota')
        self.safe_delete('ganeti.sshkey')
        self.safe_delete('ganeti.clusteruser')
        self.safe_delete('ganeti.organization')
        self.safe_delete('ganeti.profile')
        self.safe_delete('ganeti.ganetierror')
        self.safe_delete('ganeti.job')
        self.safe_delete('ganeti.virtualmachine')
        self.safe_delete('ganeti.node')
        self.safe_delete('ganeti.virtualmachinetemplate')
        self.safe_delete('ganeti.cluster')

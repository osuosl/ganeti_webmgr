...
# This is a bad way to do migrations, but using the orm[] syntax from South wasn't working
...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        # These are commented out because they aren't working right now, but they may need to be used later

        # update_all_contenttypes()
        # ContentType = orm['contenttypes.ContentType']

        # Taken from the old 0008_update_cluster_user_types migration

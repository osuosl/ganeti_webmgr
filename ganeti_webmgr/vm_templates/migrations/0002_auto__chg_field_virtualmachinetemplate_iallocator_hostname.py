...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('vm_templates_virtualmachinetemplate', 'iallocator_hostname', self.gf('ganeti_webmgr.utils.fields.LowerCaseCharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'VirtualMachineTemplate.iallocator_hostname'
        db.alter_column('vm_templates_virtualmachinetemplate', 'iallocator_hostname', self.gf('django.db.models.fields.CharField')(max_length=255))

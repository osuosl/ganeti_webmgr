...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.rename_table("ganeti_web_virtualmachinetemplate", "vm_templates_virtualmachinetemplate")
        db.send_create_signal('vm_templates', ['VirtualMachineTemplate'])


    def backwards(self, orm):
        # Deleting model 'VirtualMachineTemplate'
        db.rename_table("vm_templates_virtualmachinetemplate", "ganeti_web_virtualmachinetemplate")

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('nodes_node', 'hostname', self.gf('ganeti_webmgr.utils.fields.LowerCaseCharField')(unique=True, max_length=128))

    def backwards(self, orm):

        # Changing field 'Node.hostname'
        db.alter_column('nodes_node', 'hostname', self.gf('django.db.models.fields.CharField')(max_length=128, unique=True))

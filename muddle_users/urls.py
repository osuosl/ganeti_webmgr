...
urlpatterns = patterns('muddle_users.views.user',
    ...
    url(r'^user/(?P<user_id>\d+)/?$', 'user_detail', {'template':USER_TEMPLATE}, name="user-detail-id"),
    url(r'^users/(?P<username>\w+)/?$', 'user_detail', {'template':USER_TEMPLATE}, name="user-detail"),

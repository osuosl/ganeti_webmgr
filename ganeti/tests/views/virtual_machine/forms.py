...
from ganeti.tests.rapi_proxy import RapiProxy, XenRapiProxy, INFO, XEN_INFO
...
class TestHvmModifyVirtualMachineForm(TestCase, VirtualMachineTestCaseMixin):
    def setUp(self):
        from ganeti.tests.rapi_proxy import XEN_HVM_INSTANCE
...
class TestPvmModifyVirtualMachineForm(TestCase, VirtualMachineTestCaseMixin):
    def setUp(self):
        from ganeti.tests.rapi_proxy import XEN_PVM_INSTANCE

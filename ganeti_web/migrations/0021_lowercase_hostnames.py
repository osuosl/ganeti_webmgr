...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'VirtualMachine.hostname'
        db.alter_column('ganeti_web_virtualmachine', 'hostname', self.gf('ganeti_web.fields.LowerCaseCharField')(max_length=128))

        # Changing field 'Node.hostname'
        db.alter_column('ganeti_web_node', 'hostname', self.gf('ganeti_web.fields.LowerCaseCharField')(unique=True, max_length=128))

        # Changing field 'Cluster.hostname'
        db.alter_column('ganeti_web_cluster', 'hostname', self.gf('ganeti_web.fields.LowerCaseCharField')(unique=True, max_length=128))

        # Changing field 'VirtualMachineTemplate.iallocator_hostname'
        db.alter_column('ganeti_web_virtualmachinetemplate', 'iallocator_hostname', self.gf('ganeti_web.fields.LowerCaseCharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'VirtualMachine.hostname'
        db.alter_column('ganeti_web_virtualmachine', 'hostname', self.gf('django.db.models.fields.CharField')(max_length=128))

        # Changing field 'Node.hostname'
        db.alter_column('ganeti_web_node', 'hostname', self.gf('django.db.models.fields.CharField')(max_length=128, unique=True))

        # Changing field 'Cluster.hostname'
        db.alter_column('ganeti_web_cluster', 'hostname', self.gf('django.db.models.fields.CharField')(max_length=128, unique=True))

        # Changing field 'VirtualMachineTemplate.iallocator_hostname'
        db.alter_column('ganeti_web_virtualmachinetemplate', 'iallocator_hostname', self.gf('django.db.models.fields.CharField')(max_length=255))

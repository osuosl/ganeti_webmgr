...
CLUSTER_PARAMS = {
    'perms': {
        'admin': {
            'label': 'Admin',
            'description': 'All permissions on this cluster and its virtual '
            'machines.  Can grant/revoke permissions.'
        },
        'create_vm': {
            'label': 'Create VM',
...
VIRTUAL_MACHINE_PARAMS = {
    'perms': {
        'admin': {
            'label': 'Admin',
            'description': 'All permission on this virtual machine.  '
        ...
        'modify': {
            'label': 'Modify',
            'description': 'Can modify the settings for this virtual machine, '

...
JOB_LOG = {'end_ts': [1292007990, 759365],
 ...
 'oplog': [[[1,
             [1292007953, 699881],
             'message',
             ' - INFO: Selected nodes for instance gimager3.example.bak via \
            ...
            [3,
             [1292007954, 276561],
             'message',
             'adding instance gimager3.example.bak to cluster config'],
            [4,
             [1292007954, 357390],
             'message',
             ' - INFO: Waiting for instance gimager3.example.bak to sync \
                disks.'],
            [5,
             [1292007954, 496430],
             'message',
             " - INFO: Instance gimager3.example.bak's disks are in sync."],
            [6,
             [1292007954, 498135],
             'message',
